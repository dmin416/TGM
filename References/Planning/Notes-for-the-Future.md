...
There are enemies that have seen heat rounds.

Max will introduce vacuum tubes, better batteries, better guns, more efficient fuel, and adaptive armor against heat rounds other countries make.

Max will buy Feldberg and land around the world.

**Star Map past Level 20:** After the Level 20 ×10 ladder (1,000 km at Unity), further Star Map range is not another fixed multiplier. Max senses wherever **he can receive light**, out to a limit set by his power (not light he emits). See [MaxSystem.md](../Magic-and-Systems/MaxSystem.md) (Druid circles, past Level 20 note).

**Personal training manuals (Max):** Never change system Level. First use awakens casting; later uses only shortcut open the next spell **ring** tier. Full rules in [MaxSystem.md](../Magic-and-Systems/MaxSystem.md) (Personal training manuals).
...
**Peace Programs:** Franco-German Reconciliation 1920 (student exchanges, joint projects), Veterans Organization 1919 (international solidarity, lobbied against militarism), Paris Peace Conference 1919 (prevented punitive reparations, territorial equity, minority protection)

**Wars Prevented:** WWII 70-85M deaths, colonial independence wars 10-20M, Cold War proxies 5-10M. Total prevented: 85-115M
...
- Air conditioning (practical systems)
- Modern bra design
- Tissues (Kleenex-style)
- Cotton swabs/Q-tips
- Band-aids
- Paper towels
- Toilet paper improvements
- Automotive innovations (independent suspension, overhead cam, fuel injection, disc brakes, unibody construction, gullwing doors, tubular space frame, direct fuel injection, dry sump lubrication, lightweight alloys) for BMW 507 and Mercedes 300 SLS level sports cars
- Home refrigerator
- Freezer
...
#### Energy & Power
- Gas turbine
- Diesel improvements (direct injection, turbocharging)
- High-compression engines
- Supercharging/turbocharging refinements
...
- Thermal imaging
- Improved rangefinders
- Advanced telescopic sights
- Stereoscopic rangefinders
- Improved periscope designs
- Camera improvements (35mm, SLR concepts)

#### Future (Much Later)
- Assault rifle
- Double-stack magazine geometry
- Jet engine
- Swept-wing design
...
**Status:** Long-term alternate-history branch. **Not active in story** unless cited on page. Conflicts with OTL 1914 baseline until explicitly adopted in [World-and-Setting.md](../Setting/World-and-Setting.md) or [Alternate-History-Baseline.md](Alternate-History-Baseline.md).
