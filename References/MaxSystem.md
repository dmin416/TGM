...
Max operates within the standard magical framework but with several unique advantages.

### Dual lineage

- **Learned spells:** Acquired through study and experience, following his spellbook progression.
- **Druid inheritance:** A separate bloodline power with its own spell list, developing alongside learned magic.
...
- **Black Eagle:** True familiar and life companion, bonded during military career.
...
**Stats:** Level + 10 (Level 1 = 11, Level 2 = 12, and so on).

- 10 = average soldier.

**Druid circles:** Unlock by level number (see Druid Circles section for details).

---

## Druid circles

Passive abilities that develop alongside spell progression on a separate track.

**Level 1:** Natural Recovery (Circle of the Land). Rapid mana recovery wherever existence and mana are present. Does not function in mana voided zones.

**Level 2:** Wild Shape (Circle of the Moon). Can reshape his physical form without requiring mana. Body becomes malleable. Can take animal shapes, alter size and structure through pure physical transformation.
...
**Level 6:** Primal Strike (Circle of the Moon). Enhanced shapeshifting. Can transform into more extreme forms. Larger, stronger, more dangerous. Can layer mana reinforcement into his altered flesh and bone for supernatural durability and power.
...
**Level 10:** Elemental Wild Shape (Circle of the Moon). Can dissolve his physical body entirely and reconstitute as living elemental force. Fire, water, earth, air, lightning. Becomes the element itself rather than flesh mimicking it.
...
**Level 14:** Thousand Forms (Circle of the Moon). Complete physical control over his body. Appearance, control, everything.
...
**Level 18:** Archdruid (Circle of the Moon). Ability to take on the abilities and aspects of all creation. Not just the perfect human, but the perfect lifeform. Tardigrade, mantis shrimp, planaria, everything. Any material.
...
|---|---|---|---|---|---|---|---|---|---|
| 100000 | 120000 | 140000 | 165000 | 195000 | 225000 | 265000 | 305000 | 355000 | 450000 |
...
Start at 50. Add and subtract using the categories below.

**Training**

| Background | XP |
|------------|-----|
| Conscript or pressed man | minus 25 |
| Militia or volunteer | 0 |
| Regular army | plus 50 |
| Elite or specialist | plus 150 |
| Officer | plus 100 (stacks) |
...
|---------|-----|
| Bolt action rifle | 0 |
| Machine gun crew | plus 200 |
| Artillery crew | plus 50 |
| Partial armor | plus 100 |
| Full armored knight | plus 500 |
| Enchanted armor or items | plus 200 each |

**Magic**

| Tier | XP |
|------|-----|
| Low ring caster (rings 1 to 3) | plus 500 |
| Mid ring caster (rings 4 to 6) | plus 1500 |
| High ring caster (ring 7 plus) | plus 10000 |

**Threat**

| Situation | XP |
|-----------|-----|
| Posed no real danger | minus 25 |
| Required genuine effort | 0 |
| Nearly killed someone | plus 200 |
| Required major resource expenditure | plus 500 |
...
| Target | XP |
|--------|-----|
| Kingdom Army conscript | 25 |
| Kingdom Army rifleman | 50 |
| NCO | 200 |
| Britannia infantry | 200 |
| Britannia officer | 450 |
| MI9 officer | 700 |
| Cavalry | 100 |
| Artillery crew per man | 50 |
